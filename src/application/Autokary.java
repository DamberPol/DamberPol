...
public class Autokary {
	...
	public Autokary(int AUT_KEY, String AUT_Marka, String AUT_Model, int AUT_Rok_Prod, int AUT_Poj_silnik,
			int AUT_Spalamie_lkm, String AUT_Kat_autokaru, int AUT_Ilosc_miejsc, String AUT_Nr_rejestracji) {
